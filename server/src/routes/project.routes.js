...
import { approveBug, assignBug, createBug, getBugInfo, getProjectBugs, rejectBug, requestReopen, submitFix } from "../controllers/bug.controller.js";
...
router.route("/:projectId/bugs/:bugId/reopen")
